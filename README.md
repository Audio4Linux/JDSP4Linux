...
A: Effect have 3 option to boost low frequency, IIR based is obsoleted, equalizer already do the job.
...
1. Algorithmic spatialisation (Simulated 7.1 surround) impulse response, a quad channels that generated by my proprietary HRTF algorithm.
