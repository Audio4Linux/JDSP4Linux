...
1. Algorithmic spatialization (Simulated 5.1 surround) impulse response, a quad channels impulse response that generated by my proprietary HRTF generator algorithm.
It would be downloadable on public domain.
2. Upmixed 7.1 Spatializer (Non open source)
