...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QList<IOutputDevice> > getOutputDevices()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("getOutputDevices"), argumentList);
    }

    inline QDBusPendingReply<QList<PresetRule> > getPresetRules()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("getPresetRules"), argumentList);
    }
