...
public class BassBoost extends AudioEffect {
    ...
    /**
     * Bass boost algorithm. Paremeter ID for
     * {@link android.media.audiofx.BassBoost.OnParameterChangeListener}
     * @hide
     */
    public static final int PARAM_ALGORITHM = 3;
    /**
     * Bass boost center frequency. Paremeter ID for
     * {@link android.media.audiofx.BassBoost.OnParameterChangeListener}
     * @hide
     */
    public static final int PARAM_CENTER_FREQUENCY = 4;
    /**
     ...
     * @hide
     */
    public void setAlgorithm(short algor)
    throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        try {
            checkStatus(setParameter(PARAM_ALGORITHM, algor));
        } catch(IllegalArgumentException e) {
            // ignore
        }
    }
    ...
    public short getAlgorithm() {
        try {
            short[] value = new short[1];
            checkStatus(getParameter(PARAM_ALGORITHM, value));
            return value[0];
        } catch(IllegalArgumentException e) {
            return 0;
        }
