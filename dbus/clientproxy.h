...
/*
 * Proxy class for interface cf.thebone.jdsp4linux.Gui
 */
class CfTheboneJdsp4linuxGuiInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "cf.thebone.jdsp4linux.Gui"; }

public:
    CfTheboneJdsp4linuxGuiInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = nullptr);
