...
/**
     * Sets the decay of the virtualizer effect.
     * @param value. The valid range for the freq is [800,1100]
     * @throws IllegalStateException
     * @throws IllegalArgumentException
     * @throws UnsupportedOperationException
     * @hide
     */
    public void setEchoDecay(short decay)
    throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        try {
            checkStatus(setParameter(PARAM_ECHO_DECAY, decay));
     ...
     * @hide
     */
    public short getEchoDecay() {
        try {
            short[] value = new short[1];
            checkStatus(getParameter(PARAM_ECHO_DECAY, value));
            return value[0];
        } catch(IllegalArgumentException e) {
            return 1000;
        }
    ...
    public void setRePreset(short preset)
    throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        try {
            checkStatus(setParameter(PARAM_RE_PRESET, preset));
        } catch(IllegalArgumentException e) {
            // ignore
        }
    }
    public short getRePreset() {
        try {
            short[] value = new short[1];
            checkStatus(getParameter(PARAM_RE_PRESET, value));
            return value[0];
        } catch(IllegalArgumentException e) {
            return 0;
        }
