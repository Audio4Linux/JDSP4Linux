...
int activate(tubeFilter *tubefilter, double samplerate, double *circuitdata, int warmupDuration, int insane)
{
	...
	if (samplerate > 384000 || samplerate < 4000)
		return 0;
	tubefilter->fConst0 = samplerate;
	tubefilter->fConst1 = (2 * tubefilter->fConst0);
	tubefilter->fConst2 = pow(tubefilter->fConst1, 2);
...
int InitTube(tubeFilter *tubefilter, double *circuitparameters, double samplerate, Real tubedrive, Real bass, Real middle, Real treble, Real tonestack, int warmupDuration, int insane)
{
	...
	*/
	...
	tubefilter->toneStack0 = middle / 20.0;
	tubefilter->toneStack1 = (1.3784375e-06 * tubefilter->toneStack0);
	tubefilter->toneStack2 = (Real)exp((3.4 * (bass / 20. - 1)));
	tubefilter->toneStack3 = (8.396625e-06 + ((7.405375e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.3784375000000003e-05 * tubefilter->toneStack2) - 5.7371875e-06) - tubefilter->toneStack1))));
	tubefilter->toneStack4 = ((1.3062500000000001e-09 * tubefilter->toneStack2) - (1.30625e-10 * tubefilter->toneStack0));
	tubefilter->toneStack5 = (4.468750000000001e-09 * tubefilter->toneStack2);
	tubefilter->toneStack6 = (4.46875e-10 + (tubefilter->toneStack5 + (tubefilter->toneStack0 * (tubefilter->toneStack4 - 3.1625e-10))));
	tubefilter->toneStack7 = (tubefilter->fConst1 * tubefilter->toneStack6);
	tubefilter->toneStack8 = (0.00055 * tubefilter->toneStack0);
	tubefilter->toneStack9 = (0.0250625 * tubefilter->toneStack2);
	tubefilter->toneStack10 = (tubefilter->fConst1 * (0.01842875 + (tubefilter->toneStack9 + tubefilter->toneStack8)));
	...
	tubefilter->toneStack16 = (1.0 / tubefilter->toneStack15);
	tubefilter->toneStack17 = treble / 20.0;
	tubefilter->toneStack18 = ((tubefilter->toneStack0 * (1.30625e-10 + tubefilter->toneStack4)) + (tubefilter->toneStack17 * ((4.46875e-10 - (4.46875e-10 * tubefilter->toneStack0)) + tubefilter->toneStack5)));
	tubefilter->toneStack19 = (tubefilter->fConst3 * tubefilter->toneStack18);
	tubefilter->toneStack20 = (2.55375e-07 + (((9.912500000000003e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (1.4128125e-06 - tubefilter->toneStack1)))
		+ (tubefilter->toneStack2 * (2.5537500000000007e-06 + (1.3784375000000003e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack21 = (6.25e-05 * tubefilter->toneStack17);
	tubefilter->toneStack22 = (tubefilter->toneStack8 + tubefilter->toneStack21);
	tubefilter->toneStack23 = (0.0025062500000000002 + (tubefilter->toneStack9 + tubefilter->toneStack22));
	...
	tubefilter->toneStack33 = (1.0607618000000002e-05 * tubefilter->toneStack0);
	tubefilter->toneStack34 = (3.1187760000000004e-05 + ((0.00032604000000000004 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((0.00011284700000000001 * tubefilter->toneStack2) - 1.9801382e-05) - tubefilter->toneStack33))));
	tubefilter->toneStack35 = ((3.5814000000000013e-09 * tubefilter->toneStack2) - (3.3665160000000007e-10 * tubefilter->toneStack0));
	tubefilter->toneStack36 = (8.100000000000003e-09 * tubefilter->toneStack2);
	tubefilter->toneStack37 = (7.614000000000002e-10 + (tubefilter->toneStack36 + (tubefilter->toneStack0 * (tubefilter->toneStack35 - 4.247484000000001e-10))));
	tubefilter->toneStack38 = (tubefilter->fConst1 * tubefilter->toneStack37);
	tubefilter->toneStack39 = (0.00188 * tubefilter->toneStack0);
	tubefilter->toneStack40 = (0.060025 * tubefilter->toneStack2);
	tubefilter->toneStack41 = (tubefilter->fConst1 * (0.027267350000000003 + (tubefilter->toneStack40 + tubefilter->toneStack39)));
	...
	tubefilter->toneStack47 = (1.0 / tubefilter->toneStack46);
	tubefilter->toneStack48 = ((tubefilter->toneStack0 * (3.3665160000000007e-10 + tubefilter->toneStack35)) + (tubefilter->toneStack17 * ((7.614000000000002e-10 - (7.614000000000002e-10 * tubefilter->toneStack0)) + tubefilter->toneStack36)));
	tubefilter->toneStack49 = (tubefilter->fConst3 * tubefilter->toneStack48);
	tubefilter->toneStack50 = (1.9176000000000002e-07 + (((5.400000000000001e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (1.0654618000000002e-05 - tubefilter->toneStack33)))
		+ (tubefilter->toneStack2 * (2.0400000000000004e-06 + (0.00011284700000000001 * tubefilter->toneStack0)))));
	tubefilter->toneStack51 = (2.5e-05 * tubefilter->toneStack17);
	tubefilter->toneStack52 = (0.005642350000000001 + (tubefilter->toneStack40 + (tubefilter->toneStack39 + tubefilter->toneStack51)));
	...
	tubefilter->toneStack61 = (4.7117500000000004e-07 * tubefilter->toneStack0);
	tubefilter->toneStack62 = (0.00011998125000000002 * tubefilter->toneStack2);
	tubefilter->toneStack63 = (5.718000000000001e-06 + (tubefilter->toneStack62 + (tubefilter->toneStack0 * (((1.1779375000000001e-05 * tubefilter->toneStack2) - 4.199450000000001e-06) - tubefilter->toneStack61))));
	tubefilter->toneStack64 = ((1.0281250000000001e-09 * tubefilter->toneStack2) - (4.1125e-11 * tubefilter->toneStack0));
	tubefilter->toneStack65 = (7.343750000000001e-09 * tubefilter->toneStack2);
	tubefilter->toneStack66 = (2.9375e-10 + (tubefilter->toneStack65 + (tubefilter->toneStack0 * (tubefilter->toneStack64 - 2.52625e-10))));
	tubefilter->toneStack67 = (tubefilter->fConst1 * tubefilter->toneStack66);
	tubefilter->toneStack68 = (0.00047000000000000004 * tubefilter->toneStack0);
	tubefilter->toneStack69 = (tubefilter->fConst1 * (0.015765 + (tubefilter->toneStack9 + tubefilter->toneStack68)));
	...
	tubefilter->toneStack75 = (1.0 / tubefilter->toneStack74);
	tubefilter->toneStack76 = ((tubefilter->toneStack0 * (4.1125e-11 + tubefilter->toneStack64)) + (tubefilter->toneStack17 * ((2.9375e-10 - (2.9375e-10 * tubefilter->toneStack0)) + tubefilter->toneStack65)));
	tubefilter->toneStack77 = (tubefilter->fConst3 * tubefilter->toneStack76);
	tubefilter->toneStack78 = (9.187500000000001e-07 * tubefilter->toneStack17);
	tubefilter->toneStack79 = (9.925e-08 + ((tubefilter->toneStack78 + (tubefilter->toneStack0 * (5.0055e-07 - tubefilter->toneStack61))) + (tubefilter->toneStack2 * (2.48125e-06 + (1.1779375000000001e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack80 = (0.0010025 + (tubefilter->toneStack9 + (tubefilter->toneStack21 + tubefilter->toneStack68)));
	...
	tubefilter->toneStack89 = (3.059375000000001e-07 * tubefilter->toneStack0);
	tubefilter->toneStack90 = (1.5468750000000003e-06 + ((1.2718750000000003e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((3.0593750000000007e-06 * tubefilter->toneStack2) - 8.696875000000003e-07) - tubefilter->toneStack89))));
	tubefilter->toneStack91 = ((2.646875e-10 * tubefilter->toneStack2) - (2.6468750000000002e-11 * tubefilter->toneStack0));
	tubefilter->toneStack92 = (7.5625e-10 * tubefilter->toneStack2);
	tubefilter->toneStack93 = (7.562500000000001e-11 + (tubefilter->toneStack92 + (tubefilter->toneStack0 * (tubefilter->toneStack91 - 4.915625000000001e-11))));
	tubefilter->toneStack94 = (tubefilter->fConst1 * tubefilter->toneStack93);
	tubefilter->toneStack95 = (0.005562500000000001 * tubefilter->toneStack2);
	tubefilter->toneStack96 = (tubefilter->fConst1 * (0.005018750000000001 + (tubefilter->toneStack8 + tubefilter->toneStack95)));
	...
	tubefilter->toneStack102 = (1.0 / tubefilter->toneStack101);
	tubefilter->toneStack103 = ((tubefilter->toneStack0 * (2.6468750000000002e-11 + tubefilter->toneStack91)) + (tubefilter->toneStack17 * ((7.562500000000001e-11 - (7.562500000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack92)));
	tubefilter->toneStack104 = (tubefilter->fConst3 * tubefilter->toneStack103);
	tubefilter->toneStack105 = (6.1875e-08 + (((2.75e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (3.403125000000001e-07 - tubefilter->toneStack89))) + (tubefilter->toneStack2 * (6.1875e-07 + (3.0593750000000007e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack106 = (0.00055625 + (tubefilter->toneStack22 + tubefilter->toneStack95));
	...
	tubefilter->toneStack115 = (2.2193400000000003e-07 * tubefilter->toneStack0);
	tubefilter->toneStack116 = (2.7073879999999998e-06 + ((4.9553415999999996e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((4.882548000000001e-06 * tubefilter->toneStack2) - 1.964318e-06) - tubefilter->toneStack115))));
	tubefilter->toneStack117 = ((3.4212992000000004e-10 * tubefilter->toneStack2) - (1.5551360000000004e-11 * tubefilter->toneStack0));
	tubefilter->toneStack118 = (2.3521432000000003e-09 * tubefilter->toneStack2);
	tubefilter->toneStack119 = (1.0691560000000001e-10 + (tubefilter->toneStack118 + (tubefilter->toneStack0 * (tubefilter->toneStack117 - 9.136424e-11))));
	tubefilter->toneStack120 = (tubefilter->fConst1 * tubefilter->toneStack119);
	tubefilter->toneStack121 = (0.0103884 * tubefilter->toneStack2);
	tubefilter->toneStack122 = (tubefilter->fConst1 * (0.009920600000000002 + (tubefilter->toneStack68 + tubefilter->toneStack121)));
	...
	tubefilter->toneStack128 = (1.0 / tubefilter->toneStack127);
	tubefilter->toneStack129 = ((tubefilter->toneStack0 * (1.5551360000000004e-11 + tubefilter->toneStack117)) + (tubefilter->toneStack17 * ((1.0691560000000001e-10 - (1.0691560000000001e-10 * tubefilter->toneStack0)) + tubefilter->toneStack118)));
	tubefilter->toneStack130 = (tubefilter->fConst3 * tubefilter->toneStack129);
	tubefilter->toneStack131 = (4.3428e-08 + (((4.5496e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (2.4468200000000005e-07 - tubefilter->toneStack115))) + (tubefilter->toneStack2 * (9.55416e-07 + (4.882548000000001e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack132 = (0.00047220000000000004 + (tubefilter->toneStack121 + (tubefilter->toneStack68 + (4.84e-05 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack141 = (2.3926056000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack142 = (1.0875480000000001e-05 * tubefilter->toneStack2);
	tubefilter->toneStack143 = (1.1144196800000003e-06 + ((3.659304000000001e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * ((tubefilter->toneStack142 - 4.347578400000001e-07) - tubefilter->toneStack141))));
	tubefilter->toneStack144 = ((1.4413132800000006e-09 * tubefilter->toneStack2) - (3.1708892160000014e-11 * tubefilter->toneStack0));
	tubefilter->toneStack145 = (3.403100800000001e-09 * tubefilter->toneStack2);
	tubefilter->toneStack146 = (7.486821760000003e-11 + (tubefilter->toneStack145 + (tubefilter->toneStack0 * (tubefilter->toneStack144 - 4.315932544000001e-11))));
	tubefilter->toneStack147 = (tubefilter->fConst1 * tubefilter->toneStack146);
	tubefilter->toneStack148 = (0.00048400000000000006 * tubefilter->toneStack0);
	tubefilter->toneStack149 = (0.022470000000000004 * tubefilter->toneStack2);
	tubefilter->toneStack150 = (tubefilter->toneStack149 + tubefilter->toneStack148);
	tubefilter->toneStack151 = (tubefilter->fConst1 * (0.00358974 + tubefilter->toneStack150));
	...
	tubefilter->toneStack157 = (1.0 / tubefilter->toneStack156);
	tubefilter->toneStack158 = ((tubefilter->toneStack0 * (3.1708892160000014e-11 + tubefilter->toneStack144)) + (tubefilter->toneStack17 * ((7.486821760000003e-11 - (7.486821760000003e-11 * tubefilter->toneStack0)) + tubefilter->toneStack145)));
	tubefilter->toneStack159 = (tubefilter->fConst3 * tubefilter->toneStack158);
	tubefilter->toneStack160 = (1.0875480000000001e-05 * tubefilter->toneStack0);
	tubefilter->toneStack161 = (tubefilter->toneStack0 * (2.893061600000001e-07 - tubefilter->toneStack141));
	tubefilter->toneStack162 = (8.098288000000002e-08 + (((3.0937280000000007e-07 * tubefilter->toneStack17) + tubefilter->toneStack161) + (tubefilter->toneStack2 * (3.6810400000000007e-06 + tubefilter->toneStack160))));
	tubefilter->toneStack163 = (0.00049434 + (tubefilter->toneStack149 + (tubefilter->toneStack148 + (0.0001034 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack172 = (7.790052600000002e-07 * tubefilter->toneStack0);
	tubefilter->toneStack173 = (1.4106061200000003e-06 + ((3.7475640000000014e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((2.3606220000000006e-05 * tubefilter->toneStack2) - 3.2220474e-07) - tubefilter->toneStack172))));
	tubefilter->toneStack174 = ((1.5406083e-09 * tubefilter->toneStack2) - (5.08400739e-11 * tubefilter->toneStack0));
	tubefilter->toneStack175 = (1.9775250000000004e-09 * tubefilter->toneStack2);
	tubefilter->toneStack176 = (6.5258325e-11 + (tubefilter->toneStack175 + (tubefilter->toneStack0 * (tubefilter->toneStack174 - 1.4418251099999996e-11))));
	tubefilter->toneStack177 = (tubefilter->fConst1 * tubefilter->toneStack176);
	tubefilter->toneStack178 = (0.001551 * tubefilter->toneStack0);
	tubefilter->toneStack179 = (0.015220000000000001 * tubefilter->toneStack2);
	tubefilter->toneStack180 = (tubefilter->fConst1 * (0.0037192600000000003 + (tubefilter->toneStack179 + tubefilter->toneStack178)));
	...
	tubefilter->toneStack186 = (1.0 / tubefilter->toneStack185);
	tubefilter->toneStack187 = ((tubefilter->toneStack0 * (5.08400739e-11 + tubefilter->toneStack174)) + (tubefilter->toneStack17 * ((6.5258325e-11 - (6.5258325e-11 * tubefilter->toneStack0)) + tubefilter->toneStack175)));
	tubefilter->toneStack188 = (tubefilter->fConst3 * tubefilter->toneStack187);
	tubefilter->toneStack189 = (5.018112e-08 + (((1.7391e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (8.643102600000002e-07 - tubefilter->toneStack172)))
		+ (tubefilter->toneStack2 * (1.5206400000000001e-06 + (2.3606220000000006e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack190 = (0.0005022600000000001 + (tubefilter->toneStack179 + (tubefilter->toneStack178 + (5.4999999999999995e-05 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack199 = (4.7047000000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack200 = (5.107200000000001e-06 + ((0.00011849250000000002 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.1761750000000001e-05 * tubefilter->toneStack2) - 4.217780000000001e-06) - tubefilter->toneStack199))));
	tubefilter->toneStack201 = ((4.1125e-10 * tubefilter->toneStack2) - (1.645e-11 * tubefilter->toneStack0));
	tubefilter->toneStack202 = (2.9375000000000002e-09 * tubefilter->toneStack2);
	tubefilter->toneStack203 = (1.175e-10 + (tubefilter->toneStack202 + (tubefilter->toneStack0 * (tubefilter->toneStack201 - 1.0105e-10))));
	tubefilter->toneStack204 = (tubefilter->fConst1 * tubefilter->toneStack203);
	tubefilter->toneStack205 = (0.025025000000000002 * tubefilter->toneStack2);
	tubefilter->toneStack206 = (tubefilter->fConst1 * (0.015726 + (tubefilter->toneStack68 + tubefilter->toneStack205)));
	...
	tubefilter->toneStack212 = (1.0 / tubefilter->toneStack211);
	tubefilter->toneStack213 = ((tubefilter->toneStack0 * (1.645e-11 + tubefilter->toneStack201)) + (tubefilter->toneStack17 * ((1.175e-10 - (1.175e-10 * tubefilter->toneStack0)) + tubefilter->toneStack202)));
	tubefilter->toneStack214 = (tubefilter->fConst3 * tubefilter->toneStack213);
	tubefilter->toneStack215 = (3.9700000000000005e-08 + (((3.675000000000001e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (4.8222e-07 - tubefilter->toneStack199)))
		+ (tubefilter->toneStack2 * (9.925e-07 + (1.1761750000000001e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack216 = (0.001001 + (tubefilter->toneStack205 + (tubefilter->toneStack51 + tubefilter->toneStack68)));
	...
	tubefilter->toneStack225 = (3.0896250000000005e-07 * tubefilter->toneStack0);
	tubefilter->toneStack226 = (6.338090000000001e-07 + ((1.8734760000000003e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.2358500000000002e-05 * tubefilter->toneStack2) - 1.361249999999999e-08) - tubefilter->toneStack225))));
	tubefilter->toneStack227 = ((1.6037340000000005e-09 * tubefilter->toneStack2) - (4.0093350000000015e-11 * tubefilter->toneStack0));
	tubefilter->toneStack228 = (1.8198400000000004e-09 * tubefilter->toneStack2);
	tubefilter->toneStack229 = (4.5496000000000015e-11 + (tubefilter->toneStack228 + (tubefilter->toneStack0 * (tubefilter->toneStack227 - 5.40265e-12))));
	tubefilter->toneStack230 = (tubefilter->fConst1 * tubefilter->toneStack229);
	tubefilter->toneStack231 = (tubefilter->fConst1 * (0.00208725 + (tubefilter->toneStack8 + tubefilter->toneStack149)));
	...
	tubefilter->toneStack237 = (1.0 / tubefilter->toneStack236);
	tubefilter->toneStack238 = ((tubefilter->toneStack0 * (4.0093350000000015e-11 + tubefilter->toneStack227)) + (tubefilter->toneStack17 * ((4.5496000000000015e-11 - (4.5496000000000015e-11 * tubefilter->toneStack0)) + tubefilter->toneStack228)));
	tubefilter->toneStack239 = (tubefilter->fConst3 * tubefilter->toneStack238);
	tubefilter->toneStack240 = (8.1169e-08 + (((1.6544000000000003e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (3.735875000000001e-07 - tubefilter->toneStack225))) + (tubefilter->toneStack2 * (3.24676e-06 + (1.2358500000000002e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack241 = (0.00011750000000000001 * tubefilter->toneStack17);
	tubefilter->toneStack242 = (0.0005617500000000001 + (tubefilter->toneStack149 + (tubefilter->toneStack8 + tubefilter->toneStack241)));
	...
	tubefilter->toneStack251 = (2.7256800000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack252 = (1.4234760000000002e-06 + ((2.851440000000001e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((6.8142000000000025e-06 * tubefilter->toneStack2) - 7.876920000000001e-07) - tubefilter->toneStack251))));
	tubefilter->toneStack253 = ((4.724676000000001e-10 * tubefilter->toneStack2) - (1.8898704000000002e-11 * tubefilter->toneStack0));
	tubefilter->toneStack254 = (1.6641900000000002e-09 * tubefilter->toneStack2);
	tubefilter->toneStack255 = (6.656760000000001e-11 + (tubefilter->toneStack254 + (tubefilter->toneStack0 * (tubefilter->toneStack253 - 4.7668896000000004e-11))));
	tubefilter->toneStack256 = (tubefilter->fConst1 * tubefilter->toneStack255);
	tubefilter->toneStack257 = (0.0008200000000000001 * tubefilter->toneStack0);
	tubefilter->toneStack258 = (0.00831 * tubefilter->toneStack2);
	tubefilter->toneStack259 = (tubefilter->fConst1 * (0.005107400000000001 + (tubefilter->toneStack258 + tubefilter->toneStack257)));
	...
	tubefilter->toneStack265 = (1.0 / tubefilter->toneStack264);
	tubefilter->toneStack266 = ((tubefilter->toneStack0 * (1.8898704000000002e-11 + tubefilter->toneStack253)) + (tubefilter->toneStack17 * ((6.656760000000001e-11 - (6.656760000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack254)));
	tubefilter->toneStack267 = (tubefilter->fConst3 * tubefilter->toneStack266);
	tubefilter->toneStack268 = (3.1116000000000005e-08 + (((2.829e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (3.2176800000000005e-07 - tubefilter->toneStack251))) + (tubefilter->toneStack2 * (7.779000000000002e-07 + (6.8142000000000025e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack269 = (0.00033240000000000006 + (tubefilter->toneStack258 + (tubefilter->toneStack257 + (6e-05 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack278 = (4.0108000000000004e-07 * tubefilter->toneStack0);
	tubefilter->toneStack279 = (5.050300000000001e-06 + ((0.00010263250000000001 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.0027e-05 * tubefilter->toneStack2) - 3.5719200000000006e-06) - tubefilter->toneStack278))));
	tubefilter->toneStack280 = ((9.45e-10 * tubefilter->toneStack2) - (3.78e-11 * tubefilter->toneStack0));
	tubefilter->toneStack281 = (6.75e-09 * tubefilter->toneStack2);
	tubefilter->toneStack282 = (2.7e-10 + (tubefilter->toneStack281 + (tubefilter->toneStack0 * (tubefilter->toneStack280 - 2.3219999999999998e-10))));
	tubefilter->toneStack283 = (tubefilter->fConst1 * tubefilter->toneStack282);
	tubefilter->toneStack284 = (0.0004 * tubefilter->toneStack0);
	tubefilter->toneStack285 = (0.025067500000000003 * tubefilter->toneStack2);
	tubefilter->toneStack286 = (tubefilter->fConst1 * (0.0150702 + (tubefilter->toneStack285 + tubefilter->toneStack284)));
	...
	tubefilter->toneStack292 = (1.0 / tubefilter->toneStack291);
	tubefilter->toneStack293 = ((tubefilter->toneStack0 * (3.78e-11 + tubefilter->toneStack280)) + (tubefilter->toneStack17 * ((2.7e-10 - (2.7e-10 * tubefilter->toneStack0)) + tubefilter->toneStack281)));
	tubefilter->toneStack294 = (tubefilter->fConst3 * tubefilter->toneStack293);
	tubefilter->toneStack295 = (1.0530000000000001e-07 + (((9.45e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (4.2808000000000006e-07 - tubefilter->toneStack278))) + (tubefilter->toneStack2 * (2.6324999999999998e-06 + (1.0027e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack296 = (6.75e-05 * tubefilter->toneStack17);
	tubefilter->toneStack297 = (0.0010027 + (tubefilter->toneStack285 + (tubefilter->toneStack284 + tubefilter->toneStack296)));
	...
	tubefilter->toneStack306 = (1.95976e-07 * tubefilter->toneStack0);
	tubefilter->toneStack307 = (9.060568000000001e-07 + ((8.801210000000002e-06 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((2.4497000000000004e-06 * tubefilter->toneStack2) - 4.3256399999999996e-07) - tubefilter->toneStack306))));
	tubefilter->toneStack308 = ((2.0778120000000008e-10 * tubefilter->toneStack2) - (1.6622496000000003e-11 * tubefilter->toneStack0));
	tubefilter->toneStack309 = (5.553900000000002e-10 * tubefilter->toneStack2);
	tubefilter->toneStack310 = (4.4431200000000016e-11 + (tubefilter->toneStack309 + (tubefilter->toneStack0 * (tubefilter->toneStack308 - 2.7808704000000013e-11))));
	tubefilter->toneStack311 = (tubefilter->fConst1 * tubefilter->toneStack310);
	tubefilter->toneStack312 = (0.00044 * tubefilter->toneStack0);
	tubefilter->toneStack313 = (0.0055675 * tubefilter->toneStack2);
	tubefilter->toneStack314 = (tubefilter->fConst1 * (0.0035049 + (tubefilter->toneStack313 + tubefilter->toneStack312)));
	...
	tubefilter->toneStack320 = (1.0 / tubefilter->toneStack319);
	tubefilter->toneStack321 = ((tubefilter->toneStack0 * (1.6622496000000003e-11 + tubefilter->toneStack308)) + (tubefilter->toneStack17 * ((4.4431200000000016e-11 - (4.4431200000000016e-11 * tubefilter->toneStack0)) + tubefilter->toneStack309)));
	tubefilter->toneStack322 = (tubefilter->fConst3 * tubefilter->toneStack321);
	tubefilter->toneStack323 = (4.585680000000001e-08 + (((2.0196000000000004e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (2.2567600000000002e-07 - tubefilter->toneStack306))) + (tubefilter->toneStack2 * (5.732100000000001e-07 + (2.4497000000000004e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack324 = (0.00044540000000000004 + (tubefilter->toneStack313 + (tubefilter->toneStack296 + tubefilter->toneStack312)));
	...
	tubefilter->toneStack333 = (4.9434000000000004e-08 * tubefilter->toneStack0);
	tubefilter->toneStack334 = (7.748796000000001e-07 + ((2.8889960000000004e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((4.943400000000001e-06 * tubefilter->toneStack2) - 1.2634599999999999e-07) - tubefilter->toneStack333))));
	tubefilter->toneStack335 = ((1.2443156000000004e-09 * tubefilter->toneStack2) - (1.2443156000000002e-11 * tubefilter->toneStack0));
	tubefilter->toneStack336 = (5.345780000000001e-09 * tubefilter->toneStack2);
	tubefilter->toneStack337 = (5.345780000000001e-11 + (tubefilter->toneStack336 + (tubefilter->toneStack0 * (tubefilter->toneStack335 - 4.101464400000001e-11))));
	tubefilter->toneStack338 = (tubefilter->fConst1 * tubefilter->toneStack337);
	tubefilter->toneStack339 = (0.00022 * tubefilter->toneStack0);
	tubefilter->toneStack340 = (tubefilter->fConst1 * (0.0025277 + (tubefilter->toneStack149 + tubefilter->toneStack339)));
	...
	tubefilter->toneStack346 = (1.0 / tubefilter->toneStack345);
	tubefilter->toneStack347 = ((tubefilter->toneStack0 * (1.2443156000000002e-11 + tubefilter->toneStack335)) + (tubefilter->toneStack17 * ((5.345780000000001e-11 - (5.345780000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack336)));
	tubefilter->toneStack348 = (tubefilter->fConst3 * tubefilter->toneStack347);
	tubefilter->toneStack349 = (6.141960000000001e-08 + (((4.859800000000001e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (1.0113400000000001e-07 - tubefilter->toneStack333))) + (tubefilter->toneStack2 * (6.141960000000001e-06
		+ (4.943400000000001e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack350 = (0.00022470000000000001 + (tubefilter->toneStack149 + (tubefilter->toneStack339 + (0.00023500000000000002 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack359 = (2.5587500000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack360 = (7.717400000000001e-07 + ((2.2033600000000005e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.0235000000000001e-05 * tubefilter->toneStack2) - 1.5537499999999997e-07) - tubefilter->toneStack359))));
	tubefilter->toneStack361 = ((1.3959000000000001e-09 * tubefilter->toneStack2) - (3.48975e-11 * tubefilter->toneStack0));
	tubefilter->toneStack362 = (2.2090000000000005e-09 * tubefilter->toneStack2);
	tubefilter->toneStack363 = (5.522500000000001e-11 + (tubefilter->toneStack362 + (tubefilter->toneStack0 * (tubefilter->toneStack361 - 2.0327500000000007e-11))));
	tubefilter->toneStack364 = (tubefilter->fConst1 * tubefilter->toneStack363);
	tubefilter->toneStack365 = (0.0005 * tubefilter->toneStack0);
	tubefilter->toneStack366 = (0.020470000000000002 * tubefilter->toneStack2);
	tubefilter->toneStack367 = (tubefilter->fConst1 * (0.0025092499999999998 + (tubefilter->toneStack366 + tubefilter->toneStack365)));
	...
	tubefilter->toneStack373 = (1.0 / tubefilter->toneStack372);
	tubefilter->toneStack374 = ((tubefilter->toneStack0 * (3.48975e-11 + tubefilter->toneStack361)) + (tubefilter->toneStack17 * ((5.522500000000001e-11 - (5.522500000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack362)));
	tubefilter->toneStack375 = (tubefilter->fConst3 * tubefilter->toneStack374);
	tubefilter->toneStack376 = (8.084000000000001e-08 + (((2.2090000000000003e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (3.146250000000001e-07 - tubefilter->toneStack359)))
		+ (tubefilter->toneStack2 * (3.2336000000000007e-06 + (1.0235000000000001e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack377 = (0.00051175 + (tubefilter->toneStack366 + (tubefilter->toneStack241 + tubefilter->toneStack365)));
	...
	tubefilter->toneStack386 = (0.00022854915600000004 * tubefilter->toneStack0);
	tubefilter->toneStack387 = (0.00010871476000000002 + ((0.00010719478000000002 * tubefilter->toneStack2) + (tubefilter->toneStack0 * ((0.00012621831200000002 + (0.00022854915600000004 * tubefilter->toneStack2)) - tubefilter->toneStack386))));
	tubefilter->toneStack388 = ((3.421299200000001e-08 * tubefilter->toneStack2) - (3.421299200000001e-08 * tubefilter->toneStack0));
	tubefilter->toneStack389 = (1.0 + (tubefilter->toneStack2 + (93531720.34763868 * (tubefilter->toneStack0 * (2.3521432000000005e-08 + tubefilter->toneStack388)))));
	tubefilter->toneStack390 = (tubefilter->fConst4 * tubefilter->toneStack389);
	tubefilter->toneStack391 = (tubefilter->fConst1 * (0.036906800000000003 + ((0.022103400000000002 * tubefilter->toneStack2) + (0.01034 * tubefilter->toneStack0))));
	...
	tubefilter->toneStack397 = (1.0 / tubefilter->toneStack396);
	tubefilter->toneStack398 = ((tubefilter->toneStack0 * (3.421299200000001e-08 + tubefilter->toneStack388)) + (tubefilter->toneStack17 * ((1.0691560000000003e-08 - (1.0691560000000003e-08 * tubefilter->toneStack0)) + (1.0691560000000003e-08 * tubefilter->toneStack2))));
	tubefilter->toneStack399 = (tubefilter->fConst3 * tubefilter->toneStack398);
	tubefilter->toneStack400 = (3.7947800000000004e-06 + (((1.5199800000000001e-06 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (0.00022961831200000004 - tubefilter->toneStack386))) + (tubefilter->toneStack2 * (3.7947800000000004e-06 + tubefilter->toneStack386))));
	tubefilter->toneStack401 = (1.0 + (tubefilter->toneStack2 + ((0.0046780133373146215 * tubefilter->toneStack17) + (0.4678013337314621 * tubefilter->toneStack0))));
	...
	tubefilter->toneStack406 = (tubefilter->fConst1 * (0 - (0.022103400000000002 * tubefilter->toneStack401)));
	...
	tubefilter->toneStack410 = (4.851e-08 * tubefilter->toneStack0);
	tubefilter->toneStack411 = (7.172000000000001e-07 + ((4.972000000000001e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((4.8510000000000015e-06 * tubefilter->toneStack2) - 4.2449000000000006e-07) - tubefilter->toneStack410))));
	tubefilter->toneStack412 = ((2.6620000000000007e-10 * tubefilter->toneStack2) - (2.662e-12 * tubefilter->toneStack0));
	tubefilter->toneStack413 = (2.4200000000000003e-09 * tubefilter->toneStack2);
	tubefilter->toneStack414 = (2.4200000000000004e-11 + (tubefilter->toneStack413 + (tubefilter->toneStack0 * (tubefilter->toneStack412 - 2.1538000000000003e-11))));
	tubefilter->toneStack415 = (tubefilter->fConst1 * tubefilter->toneStack414);
	tubefilter->toneStack416 = (0.022050000000000004 * tubefilter->toneStack2);
	tubefilter->toneStack417 = (tubefilter->fConst1 * (0.0046705 + (tubefilter->toneStack339 + tubefilter->toneStack416)));
	...
	tubefilter->toneStack423 = (1.0 / tubefilter->toneStack422);
	tubefilter->toneStack424 = ((tubefilter->toneStack0 * (2.662e-12 + tubefilter->toneStack412)) + (tubefilter->toneStack17 * ((2.4200000000000004e-11 - (2.4200000000000004e-11 * tubefilter->toneStack0)) + tubefilter->toneStack413)));
	tubefilter->toneStack425 = (tubefilter->fConst3 * tubefilter->toneStack424);
	tubefilter->toneStack426 = (1.32e-08 + (((2.2000000000000004e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (5.951000000000001e-08 - tubefilter->toneStack410))) + (tubefilter->toneStack2 * (1.32e-06 + (4.8510000000000015e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack427 = (0.00022050000000000002 + (tubefilter->toneStack416 + (tubefilter->toneStack339 + (5e-05 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack436 = (1.38796875e-06 * tubefilter->toneStack0);
	tubefilter->toneStack437 = (3.5279375000000002e-06 + ((3.1989375e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.38796875e-05 * tubefilter->toneStack2) - 1.6311937500000001e-06) - tubefilter->toneStack436))));
	tubefilter->toneStack438 = ((1.0561781250000004e-09 * tubefilter->toneStack2) - (1.0561781250000003e-10 * tubefilter->toneStack0));
	tubefilter->toneStack439 = (1.9328750000000005e-09 * tubefilter->toneStack2);
	tubefilter->toneStack440 = (1.9328750000000007e-10 + (tubefilter->toneStack439 + (tubefilter->toneStack0 * (tubefilter->toneStack438 - 8.766968750000004e-11))));
	tubefilter->toneStack441 = (tubefilter->fConst1 * tubefilter->toneStack440);
	tubefilter->toneStack442 = (0.001175 * tubefilter->toneStack0);
	tubefilter->toneStack443 = (0.011812500000000002 * tubefilter->toneStack2);
	tubefilter->toneStack444 = (tubefilter->fConst1 * (0.0065077500000000005 + (tubefilter->toneStack443 + tubefilter->toneStack442)));
	...
	tubefilter->toneStack450 = (1.0 / tubefilter->toneStack449);
	tubefilter->toneStack451 = ((tubefilter->toneStack0 * (1.0561781250000003e-10 + tubefilter->toneStack438)) + (tubefilter->toneStack17 * ((1.9328750000000007e-10 - (1.9328750000000007e-10 * tubefilter->toneStack0)) + tubefilter->toneStack439)));
	tubefilter->toneStack452 = (tubefilter->fConst3 * tubefilter->toneStack451);
	tubefilter->toneStack453 = (1.0633750000000002e-07 + (((3.2900000000000005e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (1.4614062500000001e-06 - tubefilter->toneStack436)))
		+ (tubefilter->toneStack2 * (1.0633750000000002e-06 + (1.38796875e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack454 = (tubefilter->toneStack21 + tubefilter->toneStack442);
	tubefilter->toneStack455 = (0.00118125 + (tubefilter->toneStack443 + tubefilter->toneStack454));
	...
	tubefilter->toneStack464 = (3.0937500000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack465 = (1.2375000000000003e-05 * tubefilter->toneStack2);
	tubefilter->toneStack466 = (6.677000000000001e-07 + ((1.9448000000000004e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * ((tubefilter->toneStack465 - 2.1175000000000003e-08) - tubefilter->toneStack464))));
	tubefilter->toneStack467 = ((1.7121500000000001e-09 * tubefilter->toneStack2) - (4.2803750000000003e-11 * tubefilter->toneStack0));
	tubefilter->toneStack468 = (1.9965000000000003e-09 * tubefilter->toneStack2);
	tubefilter->toneStack469 = (4.991250000000001e-11 + (tubefilter->toneStack468 + (tubefilter->toneStack0 * (tubefilter->toneStack467 - 7.108750000000004e-12))));
	tubefilter->toneStack470 = (tubefilter->fConst1 * tubefilter->toneStack469);
	tubefilter->toneStack471 = (0.022500000000000003 * tubefilter->toneStack2);
	tubefilter->toneStack472 = (tubefilter->toneStack8 + tubefilter->toneStack471);
	tubefilter->toneStack473 = (tubefilter->fConst1 * (0.0021395000000000003 + tubefilter->toneStack472));
	...
	tubefilter->toneStack479 = (1.0 / tubefilter->toneStack478);
	tubefilter->toneStack480 = ((tubefilter->toneStack0 * (4.2803750000000003e-11 + tubefilter->toneStack467)) + (tubefilter->toneStack17 * ((4.991250000000001e-11 - (4.991250000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack468)));
	tubefilter->toneStack481 = (tubefilter->fConst3 * tubefilter->toneStack480);
	tubefilter->toneStack482 = (1.2375000000000003e-05 * tubefilter->toneStack0);
	tubefilter->toneStack483 = (tubefilter->toneStack0 * (3.781250000000001e-07 - tubefilter->toneStack464));
	tubefilter->toneStack484 = (8.690000000000002e-08 + (((1.815e-07 * tubefilter->toneStack17) + tubefilter->toneStack483) + (tubefilter->toneStack2 * (3.4760000000000007e-06 + tubefilter->toneStack482))));
	tubefilter->toneStack485 = (0.0005625000000000001 + (tubefilter->toneStack471 + (tubefilter->toneStack8 + (0.000125 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack494 = (3.0621250000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack495 = (5.442360000000002e-07 + ((1.784904e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.2248500000000003e-05 * tubefilter->toneStack2) - 5.596250000000005e-08) - tubefilter->toneStack494))));
	tubefilter->toneStack496 = ((9.245610000000004e-10 * tubefilter->toneStack2) - (2.3114025000000008e-11 * tubefilter->toneStack0));
	tubefilter->toneStack497 = (1.0781100000000005e-09 * tubefilter->toneStack2);
	tubefilter->toneStack498 = (2.695275000000001e-11 + (tubefilter->toneStack497 + (tubefilter->toneStack0 * (tubefilter->toneStack496 - 3.8387250000000005e-12))));
	tubefilter->toneStack499 = (tubefilter->fConst1 * tubefilter->toneStack498);
	tubefilter->toneStack500 = (0.02227 * tubefilter->toneStack2);
	tubefilter->toneStack501 = (tubefilter->fConst1 * (0.00207625 + (tubefilter->toneStack8 + tubefilter->toneStack500)));
	...
	tubefilter->toneStack507 = (1.0 / tubefilter->toneStack506);
	tubefilter->toneStack508 = ((tubefilter->toneStack0 * (2.3114025000000008e-11 + tubefilter->toneStack496)) + (tubefilter->toneStack17 * ((2.695275000000001e-11 - (2.695275000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack497)));
	tubefilter->toneStack509 = (tubefilter->fConst3 * tubefilter->toneStack508);
	tubefilter->toneStack510 = (4.6926e-08 + (((9.801000000000002e-08 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (3.433375000000001e-07 - tubefilter->toneStack494))) + (tubefilter->toneStack2 * (1.8770400000000002e-06 + (1.2248500000000003e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack511 = (0.0005567500000000001 + (tubefilter->toneStack500 + (tubefilter->toneStack8 + tubefilter->toneStack296)));
	...
	tubefilter->toneStack520 = (1.08515e-06 + ((3.108600000000001e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * ((tubefilter->toneStack465 - 2.99475e-07) - tubefilter->toneStack464))));
	tubefilter->toneStack521 = ((1.8513000000000002e-09 * tubefilter->toneStack2) - (4.628250000000001e-11 * tubefilter->toneStack0));
	tubefilter->toneStack522 = (3.3880000000000003e-09 * tubefilter->toneStack2);
	tubefilter->toneStack523 = (8.470000000000002e-11 + (tubefilter->toneStack522 + (tubefilter->toneStack0 * (tubefilter->toneStack521 - 3.8417500000000006e-11))));
	tubefilter->toneStack524 = (tubefilter->fConst1 * tubefilter->toneStack523);
	tubefilter->toneStack525 = (tubefilter->fConst1 * (tubefilter->toneStack472 + 0.0031515000000000002));
	...
	tubefilter->toneStack531 = (1.0 / tubefilter->toneStack530);
	tubefilter->toneStack532 = ((tubefilter->toneStack0 * (4.628250000000001e-11 + tubefilter->toneStack521)) + (tubefilter->toneStack17 * ((8.470000000000002e-11 - (8.470000000000002e-11 * tubefilter->toneStack0)) + tubefilter->toneStack522)));
	tubefilter->toneStack533 = (tubefilter->fConst3 * tubefilter->toneStack532);
	tubefilter->toneStack534 = (9.955000000000001e-08 + ((tubefilter->toneStack483 + (3.08e-07 * tubefilter->toneStack17)) + (tubefilter->toneStack2 * (tubefilter->toneStack482 + 3.982e-06))));
	...
	tubefilter->toneStack541 = (5.665800800000001e-07 + ((1.892924e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * ((tubefilter->toneStack142 - 6.207784000000001e-08) - tubefilter->toneStack141))));
	tubefilter->toneStack542 = ((1.2661536800000005e-09 * tubefilter->toneStack2) - (2.7855380960000008e-11 * tubefilter->toneStack0));
	tubefilter->toneStack543 = (1.6515048000000004e-09 * tubefilter->toneStack2);
	tubefilter->toneStack544 = (3.6333105600000014e-11 + (tubefilter->toneStack543 + (tubefilter->toneStack0 * (tubefilter->toneStack542 - 8.477724640000006e-12))));
	tubefilter->toneStack545 = (tubefilter->fConst1 * tubefilter->toneStack544);
	tubefilter->toneStack546 = (tubefilter->fConst1 * (tubefilter->toneStack150 + 0.0020497400000000004));
	...
	tubefilter->toneStack552 = (1.0 / tubefilter->toneStack551);
	tubefilter->toneStack553 = ((tubefilter->toneStack0 * (2.7855380960000008e-11 + tubefilter->toneStack542)) + (tubefilter->toneStack17 * ((3.6333105600000014e-11 - (3.6333105600000014e-11 * tubefilter->toneStack0)) + tubefilter->toneStack543)));
	tubefilter->toneStack554 = (tubefilter->fConst3 * tubefilter->toneStack553);
	tubefilter->toneStack555 = (6.505928000000001e-08 + ((tubefilter->toneStack161 + (1.5013680000000003e-07 * tubefilter->toneStack17)) + (tubefilter->toneStack2 * (tubefilter->toneStack160 + 2.95724e-06))));
	...
	tubefilter->toneStack562 = (1.0855872000000003e-07 * tubefilter->toneStack0);
	tubefilter->toneStack563 = (3.222390000000001e-06 + (tubefilter->toneStack62 + (tubefilter->toneStack0 * (((5.6541000000000015e-06 * tubefilter->toneStack2) - 2.1333412800000006e-06) - tubefilter->toneStack562))));
	tubefilter->toneStack564 = (4.935e-10 * tubefilter->toneStack2);
	tubefilter->toneStack565 = (tubefilter->toneStack564 - (9.4752e-12 * tubefilter->toneStack0));
	tubefilter->toneStack566 = (1.41e-10 + (tubefilter->toneStack65 + (tubefilter->toneStack0 * (tubefilter->toneStack565 - 1.315248e-10))));
	tubefilter->toneStack567 = (tubefilter->fConst1 * tubefilter->toneStack566);
	tubefilter->toneStack568 = (0.0002256 * tubefilter->toneStack0);
	tubefilter->toneStack569 = (tubefilter->fConst1 * (0.015243699999999999 + (tubefilter->toneStack9 + tubefilter->toneStack568)));
	...
	tubefilter->toneStack575 = (1.0 / tubefilter->toneStack574);
	tubefilter->toneStack576 = (1.41e-10 - (1.41e-10 * tubefilter->toneStack0));
	tubefilter->toneStack577 = ((tubefilter->toneStack0 * (9.4752e-12 + tubefilter->toneStack565)) + (tubefilter->toneStack17 * (tubefilter->toneStack65 + tubefilter->toneStack576)));
	tubefilter->toneStack578 = (tubefilter->fConst3 * tubefilter->toneStack577);
	tubefilter->toneStack579 = (4.764000000000001e-08 + ((tubefilter->toneStack78 + (tubefilter->toneStack0 * (1.2265872000000003e-07 - tubefilter->toneStack562)))
		+ (tubefilter->toneStack2 * (2.48125e-06 + (5.6541000000000015e-06 * tubefilter->toneStack0)))));
	tubefilter->toneStack580 = (0.00048120000000000004 + (tubefilter->toneStack9 + (tubefilter->toneStack21 + tubefilter->toneStack568)));
	...
	tubefilter->toneStack589 = (4.7056400000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack590 = (5.188640000000001e-06 + ((0.00011869100000000002 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.1764100000000001e-05 * tubefilter->toneStack2) - 4.215336e-06) - tubefilter->toneStack589))));
	tubefilter->toneStack591 = (tubefilter->toneStack564 - (1.974e-11 * tubefilter->toneStack0));
	tubefilter->toneStack592 = (3.525e-09 * tubefilter->toneStack2);
	tubefilter->toneStack593 = (1.41e-10 + (tubefilter->toneStack592 + (tubefilter->toneStack0 * (tubefilter->toneStack591 - 1.2126e-10))));
	tubefilter->toneStack594 = (tubefilter->fConst1 * tubefilter->toneStack593);
	tubefilter->toneStack595 = (0.02503 * tubefilter->toneStack2);
	tubefilter->toneStack596 = (tubefilter->fConst1 * (0.0157312 + (tubefilter->toneStack68 + tubefilter->toneStack595)));
	...
	tubefilter->toneStack602 = (1.0 / tubefilter->toneStack601);
	tubefilter->toneStack603 = ((tubefilter->toneStack0 * (1.974e-11 + tubefilter->toneStack591)) + (tubefilter->toneStack17 * (tubefilter->toneStack576 + tubefilter->toneStack592)));
	tubefilter->toneStack604 = (tubefilter->fConst3 * tubefilter->toneStack603);
	tubefilter->toneStack605 = (4.764000000000001e-08 + (((4.410000000000001e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (4.846640000000001e-07 - tubefilter->toneStack589)))
		+ (tubefilter->toneStack2 * (1.1910000000000001e-06 + (1.1764100000000001e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack606 = (0.0010012 + (tubefilter->toneStack595 + (tubefilter->toneStack68 + (3e-05 * tubefilter->toneStack17))));
	...
	tubefilter->toneStack615 = (2.9448437500000003e-06 * tubefilter->toneStack0);
	tubefilter->toneStack616 = (1.2916875000000002e-05 + (tubefilter->toneStack62 + (tubefilter->toneStack0 * (((2.9448437500000007e-05 * tubefilter->toneStack2) - 8.731718750000001e-06) - tubefilter->toneStack615))));
	tubefilter->toneStack617 = ((2.5703125000000004e-09 * tubefilter->toneStack2) - (2.5703125000000003e-10 * tubefilter->toneStack0));
	tubefilter->toneStack618 = (7.343750000000001e-10 + (tubefilter->toneStack65 + (tubefilter->toneStack0 * (tubefilter->toneStack617 - 4.773437500000001e-10))));
	tubefilter->toneStack619 = (tubefilter->fConst1 * tubefilter->toneStack618);
	tubefilter->toneStack620 = (tubefilter->fConst1 * (0.01726875 + (tubefilter->toneStack9 + tubefilter->toneStack442)));
	...
	tubefilter->toneStack626 = (1.0 / tubefilter->toneStack625);
	tubefilter->toneStack627 = ((tubefilter->toneStack0 * (2.5703125000000003e-10 + tubefilter->toneStack617)) + (tubefilter->toneStack17 * (tubefilter->toneStack65 + (7.343750000000001e-10 - (7.343750000000001e-10 * tubefilter->toneStack0)))));
	tubefilter->toneStack628 = (tubefilter->fConst3 * tubefilter->toneStack627);
	tubefilter->toneStack629 = (2.48125e-07 + ((tubefilter->toneStack78 + (tubefilter->toneStack0 * (3.0182812500000004e-06 - tubefilter->toneStack615))) + (tubefilter->toneStack2 * (2.48125e-06 + (2.9448437500000007e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack630 = (0.0025062500000000002 + (tubefilter->toneStack9 + tubefilter->toneStack454));
	...
	tubefilter->toneStack639 = (2.5312500000000006e-07 * tubefilter->toneStack0);
	tubefilter->toneStack640 = (7.4525e-07 + ((2.4210000000000004e-05 * tubefilter->toneStack2) + (tubefilter->toneStack0 * (((1.0125e-05 * tubefilter->toneStack2) - 2.75625e-07) - tubefilter->toneStack639))));
	tubefilter->toneStack641 = ((7.650000000000002e-10 * tubefilter->toneStack2) - (1.9125000000000002e-11 * tubefilter->toneStack0));
	tubefilter->toneStack642 = (1.4000000000000001e-09 * tubefilter->toneStack2);
	tubefilter->toneStack643 = (3.500000000000001e-11 + (tubefilter->toneStack642 + (tubefilter->toneStack0 * (tubefilter->toneStack641 - 1.5875000000000007e-11))));
	tubefilter->toneStack644 = (tubefilter->fConst1 * tubefilter->toneStack643);
	tubefilter->toneStack645 = (0.02025 * tubefilter->toneStack2);
	tubefilter->toneStack646 = (tubefilter->fConst1 * (0.0028087500000000005 + (tubefilter->toneStack365 + tubefilter->toneStack645)));
	...
	tubefilter->toneStack652 = (1.0 / tubefilter->toneStack651);
	tubefilter->toneStack653 = ((tubefilter->toneStack0 * (1.9125000000000002e-11 + tubefilter->toneStack641)) + (tubefilter->toneStack17 * ((3.500000000000001e-11 - (3.500000000000001e-11 * tubefilter->toneStack0)) + tubefilter->toneStack642)));
	tubefilter->toneStack654 = (tubefilter->fConst3 * tubefilter->toneStack653);
	tubefilter->toneStack655 = (4.525e-08 + (((1.4e-07 * tubefilter->toneStack17) + (tubefilter->toneStack0 * (2.8437500000000003e-07 - tubefilter->toneStack639))) + (tubefilter->toneStack2 * (1.8100000000000002e-06 + (1.0125e-05 * tubefilter->toneStack0)))));
	tubefilter->toneStack656 = (0.00050625 + (tubefilter->toneStack645 + (tubefilter->toneStack21 + tubefilter->toneStack365)));
