...
static const qreal TabBarTab_Rounding = 5.0;
static const qreal SpinBox_Rounding = 5.0;
static const qreal LineEdit_Rounding = 5.0;
static const qreal FrameFocusRect_Rounding = 1.0;
static const qreal PushButton_Rounding = 5.0;
static const qreal ToolButton_Rounding = 5.0;
static const qreal ProgressBar_Rounding = 5.0;
static const qreal GroupBox_Rounding = 5.0;
static const qreal SliderGroove_Rounding = 2.0;
static const qreal SliderHandle_Rounding = 5.0;
...
static const bool TabBar_InactiveTabsHaveSpecular = true;
...
Q_NEVER_INLINE void PhSwatch::loadFromQPalette(const QPalette& pal) {
  ...
  if (colors[S_button] == colors[S_window])
    colors[S_button] = Dc::adjustLightness(colors[S_button], 0.05);
  ...
  colors[S_highlight_outline] = Dc::adjustLightness(colors[S_highlight], -0.15);
...
void PhantomStyle::drawPrimitive(PrimitiveElement elem,
  ...
  case PE_FrameTabWidget: {
    ...
    painter->fillRect(bgRect, Phantom::DeriveColors::adjustLightness(swatch.color(S_tabFrame),0.1));
...
QRect PhantomStyle::subControlRect(ComplexControl control,
  ...
  case CC_Slider: {
    ...
    case SC_SliderGroove: {
      ...
      const int grooveThickness = (int)Ph::dpiScaled(6);
      if (slider->orientation == Qt::Horizontal) {
