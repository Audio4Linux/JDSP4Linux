...
public class EqualizerSurface extends SurfaceView {
    private static int MIN_FREQ = 12;
    ...
    private float[] mLevels = new float[8];
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 71; i++) {
            ...
            double dB = lin2dB(gain * z2.rho() * z3.rho() * z4.rho() * z5.rho() * z6.rho() * z7.rho() * z8.rho());
