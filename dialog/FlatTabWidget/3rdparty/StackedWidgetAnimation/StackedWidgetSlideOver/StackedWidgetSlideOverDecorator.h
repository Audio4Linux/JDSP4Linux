...
#ifndef STACKEDWIDGETSLIDEOVERDECORATOR_H
#define STACKEDWIDGETSLIDEOVERDECORATOR_H
...
namespace WAF
{
	 ...
	 */
	class StackedWidgetSlideOverDecorator : public QWidget
	{
		Q_OBJECT

	public:
		explicit StackedWidgetSlideOverDecorator(QWidget* _parent, QWidget* _widgetForGrab);
...
#endif // STACKEDWIDGETSLIDEOVERDECORATOR_H
