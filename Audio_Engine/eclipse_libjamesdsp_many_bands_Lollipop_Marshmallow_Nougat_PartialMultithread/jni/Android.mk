...
LOCAL_CPPFLAGS += -ffunction-sections -fdata-sections -Ofast -ftree-vectorize -DHYBRIDCONV_USE_SSE -DNDEBUG# -DDEBUG
LOCAL_CFLAGS += -ffunction-sections -fdata-sections -Ofast -ftree-vectorize -DHYBRIDCONV_USE_SSE -DNDEBUG# -DDEBUG
else ifeq ($(TARGET_ARCH_ABI), armeabi)
