...
void EffectEqualizer::refreshBands()
{
            ...
            mSOS3Band4L.setSOS(bs3[2].getA0(), bs3[2].getA1(), bs3[2].getA2(), bs3[2].getB0(), bs3[2].getB1(), bs3[2].getB2());
            mSOS3Band4R.setSOS(bs3[2].getA0(), bs3[2].getA1(), bs3[2].getA2(), bs3[2].getB0(), bs3[2].getB1(), bs3[2].getB2());
            ...
            mSOS3Band5L.setSOS(bs4[2].getA0(), bs4[2].getA1(), bs4[2].getA2(), bs4[2].getB0(), bs4[2].getB1(), bs4[2].getB2());
            mSOS3Band5R.setSOS(bs4[2].getA0(), bs4[2].getA1(), bs4[2].getA2(), bs4[2].getB0(), bs4[2].getB1(), bs4[2].getB2());
            ...
            Iir::Butterworth::BandShelf<10> bs9;
            bs9.setup (10, mSamplingRate, 7000.0f, 2500.0, mBand[9]*0.95);
            ...
            mSOS5Band10L.setSOS(bs9[4].getA0(), bs9[4].getA1(), bs9[4].getA2(), bs9[4].getB0(), bs9[4].getB1(), bs9[4].getB2());
            mSOS5Band10R.setSOS(bs9[4].getA0(), bs9[4].getA1(), bs9[4].getA2(), bs9[4].getB0(), bs9[4].getB1(), bs9[4].getB2());
            mPeakFilter11L.setPeaking(11000.0f, mSamplingRate, mBand[10]*0.8, 2.0f);
            mPeakFilter11R.setPeaking(11000.0f, mSamplingRate, mBand[10]*0.8, 2.0f);
...
int32_t EffectEqualizer::process(audio_buffer_t *in, audio_buffer_t *out)
{
    for (uint32_t i = 0; i < in->frameCount; i ++) {
        ...
        dryL = mSOS5Band10L.process(dryL);
