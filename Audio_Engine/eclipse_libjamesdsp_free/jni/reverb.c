...
void sf_presetreverb(sf_reverb_state_st *rv, int rate, sf_reverb_preset preset)
{
    ...
    } ps[] =
    {
        ...
        { 2, 0.00f,-70.0f,-18, 1.0f, 1.0f, 1.0f, -8, 0.20f, 0.10f, 1.6f,18000,1000,16000,18000, 1.8f,0.000f },
        { 2, 0.00f,-70.0f,-18, 1.0f, 1.0f, 1.0f, -8, 0.30f, 0.20f, 0.4f,18000, 500, 9000,18000, 1.9f,0.000f },
