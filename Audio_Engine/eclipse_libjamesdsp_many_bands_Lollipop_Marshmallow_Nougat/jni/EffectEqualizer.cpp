...
{
	Iir::Butterworth::LowShelf<4> ls;
	ls.setup(4, mSamplingRate, 32.0, mBand[0]*1.1);
	...
	Iir::Butterworth::BandShelf<4> bs1;
	bs1.setup(4, mSamplingRate, 64.0f, 52.0, mBand[1]);
	...
	mSOS3Band2L.setSOS(bs1[2].getA0(), bs1[2].getA1(), bs1[2].getA2(), bs1[2].getB0(), bs1[2].getB1(), bs1[2].getB2());
	mSOS3Band2R.setSOS(bs1[2].getA0(), bs1[2].getA1(), bs1[2].getA2(), bs1[2].getB0(), bs1[2].getB1(), bs1[2].getB2());
	mSOS4Band2L.setSOS(bs1[3].getA0(), bs1[3].getA1(), bs1[3].getA2(), bs1[3].getB0(), bs1[3].getB1(), bs1[3].getB2());
	mSOS4Band2R.setSOS(bs1[3].getA0(), bs1[3].getA1(), bs1[3].getA2(), bs1[3].getB0(), bs1[3].getB1(), bs1[3].getB2());
	Iir::Butterworth::BandShelf<3> bs2;
	bs2.setup(3, mSamplingRate, 126.0f, 66.0, mBand[2]);
	...
	Iir::Butterworth::BandShelf<2> bs3;
	bs3.setup(2, mSamplingRate, 220.0f, 110.0, mBand[3]);
	...
	Iir::Butterworth::BandShelf<2> bs4;
	bs4.setup(2, mSamplingRate, 380.0f, 180.0, mBand[4]);
	...
	Iir::Butterworth::BandShelf<3> bs5;
	bs5.setup(3, mSamplingRate, 750.0f, 600.0, mBand[5]);
	...
	Iir::Butterworth::BandShelf<3> bs6;
	bs6.setup(3, mSamplingRate, 1600.0f, 1000.0, mBand[6] * 0.95);
	...
	Iir::Butterworth::BandShelf<3> bs7;
	bs7.setup(3, mSamplingRate, 3000.0f, 1800.0, mBand[7]);
	...
	Iir::Butterworth::BandShelf<3> bs8;
	bs8.setup(3, mSamplingRate, 4800.0f, 1800.0, mBand[8]*0.9);
	...
	Iir::Butterworth::BandShelf<2> bs9;
	bs9.setup(2, mSamplingRate, 7000.0f, 2800.0, mBand[9]);
	...
	Iir::Butterworth::BandShelf<2> bs10;
	bs10.setup(2, mSamplingRate, 11000.0f, 3400.0, mBand[10] * 0.925);
	mSOS1Band11L.setSOS(bs10[0].getA0(), bs10[0].getA1(), bs10[0].getA2(), bs10[0].getB0(), bs10[0].getB1(), bs10[0].getB2());
	mSOS1Band11R.setSOS(bs10[0].getA0(), bs10[0].getA1(), bs10[0].getA2(), bs10[0].getB0(), bs10[0].getB1(), bs10[0].getB2());
	mSOS2Band11L.setSOS(bs10[1].getA0(), bs10[1].getA1(), bs10[1].getA2(), bs10[1].getB0(), bs10[1].getB1(), bs10[1].getB2());
	mSOS2Band11R.setSOS(bs10[1].getA0(), bs10[1].getA1(), bs10[1].getA2(), bs10[1].getB0(), bs10[1].getB1(), bs10[1].getB2());
	Iir::Butterworth::HighShelf<2> bs11;
	bs11.setup(2, mSamplingRate, 15000.0f, mBand[11]);
	mHSFilter12L.setSOS(bs11[0].getA0(), bs11[0].getA1(), bs11[0].getA2(), bs11[0].getB0(), bs11[0].getB1(), bs11[0].getB2());
	mHSFilter12R.setSOS(bs11[0].getA0(), bs11[0].getA1(), bs11[0].getA2(), bs11[0].getB0(), bs11[0].getB1(), bs11[0].getB2());
}
