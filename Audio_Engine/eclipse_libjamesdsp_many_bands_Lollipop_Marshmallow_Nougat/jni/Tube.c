...
int activate(tubeFilter *tubefilter, double samplerate, double *circuitdata, int insane)
{
    Real Fs = samplerate;
    // Passive components
...
int InitTube(tubeFilter *tubefilter, double *circuitparameters, double samplerate, float tubedrive, float bass, float middle, float treble, float tonestack, float mastergain, int insane)
{
	...
	*/
	...
	tubefilter->mastergain = from_dB(mastergain);
	tubefilter->overdrived1Gain = from_dB(tubedrive);
	tubefilter->overdrived2Gain = 10.0f * from_dB(30.f - tubedrive) * from_dB(12.0f);
	if (!activate(tubefilter, samplerate, circuitparameters, insane))
		return 0;
...
void processTube(tubeFilter *tubefilter, float* inputs, float* outputs, unsigned frames)
{
	...
	for (i = 0; i < frames; ++i)
	{
		...
		outputs[i] = ((tubefilter->toneStack664 * ((tubefilter->toneStack663 * tubefilter->fRec24[0]) + ((tubefilter->toneStack662 * tubefilter->fRec24[1]) + ((tubefilter->toneStack660 * tubefilter->fRec24[3])
																								...
																								+ ((tubefilter->toneStack88 * ((tubefilter->toneStack87 * tubefilter->fRec2[0]) + ((tubefilter->toneStack86 * tubefilter->fRec2[1])
																									...
																									+ ((tubefilter->toneStack60 * ((tubefilter->toneStack59 * tubefilter->fRec1[0]) + ((tubefilter->toneStack58 * tubefilter->fRec1[1])
																										...
																										+ (tubefilter->toneStack32 * ((tubefilter->toneStack30 * tubefilter->fRec0[0]) + ((tubefilter->toneStack29 * tubefilter->fRec0[1])
																											+ ((tubefilter->toneStack27 * tubefilter->fRec0[3]) + (tubefilter->toneStack25 * tubefilter->fRec0[2])))))))))))))))))))))))))))))* tubefilter->mastergain;
		//outputs[i] = (outputs[i]);
