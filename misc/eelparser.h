...
class EELParser : public QObject
{
    Q_OBJECT
public:
    EELParser();
...
private:
    ...
    QString findVariable(QString key, EELPropertyType type);
    bool replaceVariable(QString key, QString value, EELPropertyType type);
};
...
class EELBaseProperty{
public:
    EELBaseProperty(QString _key, QString _description){
        key = _key;
...
class EELNumberRangeProperty : public EELBaseProperty {
public:
    EELNumberRangeProperty(QString _key, QString _description, TNum _value,
                           TNum _minimum, TNum _maximum, TNum _defaultVal = 0){
        key = _key;
        description = _description;
        value = _value;
        maximum = _maximum;
